...
\begin{document}
\section{Convenzioni del codice da utilizzare} Stabilito pro nobis et intra 
...
\begin{enumerate}
    \item 4 spazi per le indentazioni.
    ...
    essere autoesplicativi (fa rima con il pattern di refactoring "Extract 
    method").
    ...
    per le parentesi tonde. \texttt{else} e \texttt{catch} sono un'eccezione.
...
\begin{enumerate}
    ...
    utilizzare puntatori a funzione. // abrogata per il pattern Strategy.
